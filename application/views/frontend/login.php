        ...
        <div class="container" align="center">
            <form class="form-login" style="width:500px;background-color:#E0E0E0;padding:15px;margin-top:100px;">
                <h2 class="form-login-heading"
                    style="background-color:#067780;font-weight:bold;font-size:35px;padding:15px;color:#FFF;">
                ...
                <div class="login-wrap" align="left" style="padding-top: 10px;">
                    ...
                    <button class="btn btn-primary btn-block btn-xs" id="btnLogin" type="button"><i
