...
function saveData() {
    ...
    formData.append('txtRankName', $("#txtRankName").val());
    formData.append('txtDefinition', $("#txtDefinition").val());
    formData.append('txtNumber', $("#txtNumber").val());
    formData.append('txtcadangan', $("#txtcadangan").val());
...
function getDataEdit(id, type) {
    ...
    $.post('<?php echo base_url("master/getDataEdit"); ?>', {
        ...
        function(data) {
            ...
            $("#txtcadangan").val(data['rsl'][0]['cadangan'])
            ...
            <table class="table table-border table-striped table-bordered table-condensed table-advance table-hover"
                ...
                <thead>
                    <tr style="background-color:#067780;color:#FFF;height:30px;">
                        ...
                        <th style="vertical-align:middle;width:30%;text-align:center;">CADANGAN</th>
    ...
    <div class="col-md-4 col-xs-12" style="background-color:#ABABAB;padding:5px;">
        <div class="row" style="">
            ...
            <div class="col-md-6 col-xs-12">
                ...
                <input type="text" class="form-control input-sm" id="txtcadangan" value="" placeholder="Number">
            </div>
        </div>
