        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-md-2 col-xs-12">
                        <button class="btn btn-info btn-xs btn-block" title="Calculate" style="margin-top:5px;"
                            onclick="calculateDate();">Calculate</button>
                    </div>
                </div>
                <div class="row" style="margin-top:2px;">
                    <div class="col-md-4 col-xs-12">
                    ...
                    <div class="col-md-3 col-xs-12">
                        <input type="text" class="form-control input-sm" id="txtDate_EstSignOffCont" value=""
                            placeholder="Date">
                    </div>
                </div>
                <div class="row" style="margin-top:2px;">
                ...
                <div class="row" style="margin-top:2px;">
                    <div class="col-md-4 col-xs-12">
                        <label for="slcReplacementCont">Replacement Candidare</label><label
                            style="float:right;">:</label>
                    </div>
                    <div class="col-md-5 col-xs-12">
                ...
                <div class="row" style="margin-top:2px;">
                    ...
                    <div class="col-md-2 col-xs-12">
                        <button class="btn btn-warning btn-xs btn-block"
                            onclick="$('#uploadFileContract').val('')">Clear</button>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="row" style="margin-top:5px;">
            <div class="col-md-1 col-xs-12">
                <button class="btn btn-primary btn-xs btn-block" title="Add Data" id="btnAddSea"><i
