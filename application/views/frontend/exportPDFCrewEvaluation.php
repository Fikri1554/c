...
<body
    ...
    <div style="text-align: left; margin-bottom: 5px;">
        <img src="<?php echo base_url(); ?>assets/img/andhika.gif" alt="logo"
    ...
    <div style="background:#fff; margin-bottom: 6px;">
        ...
        <div style="border:1px solid black; padding:4px; font-size:10px;">
            <div style="margin-bottom:4px;">Acknowledge</div>
            Seafarer's signature:<br>
            <img src="<?php echo $qrCodePathSeafarer; ?>" alt="QR Code"
                style="width:60px; height:auto; margin:4px 0;"><br>
            Seafarer's Name:<br>
            <?php echo $seafarerName; ?>
        </div>
        ...
        <table style="width:100%; border-collapse:collapse; font-size:10px;">
            <tr>
                <td style="border:1px solid black; padding:4px;">
                    ...
                    Signature:<br>
                    <img src="<?php echo $qrCodeImg; ?>" alt="QR Code" style="width:60px; height:auto; margin:4px 0;">
                </td>
                <td style=" border:1px solid black; padding:4px;">
                    Master / COO<br>
                    ...
                    <img src="<?php echo $qrCodePathMaster; ?>" alt="QR Code"
                        style="width:60px; height:auto; margin:4px 0; margin-top:22px;">
                </td>
                <td style="border:1px solid black; padding:4px;">
                    Received by CM:<br>
                    ...
                    Signature:<br>
                    <img src="<?php echo $qrCodePathCM; ?>" alt="QR Code" style="width:60px; height:auto; margin:4px 0;
                            margin-top:10px;">
                </td>
            </tr>
        </table>
