...
function exportPDF() {
    var idPerson = $("#txtIdPersonAllCertificate").val();
    window.location.href = "<?php echo base_url('personal/exportPDFCertificate/'); ?>" + '/' + idPerson;
}
</script>
...
<div class="row" style="margin-top:5px;">
    ...
    <div class="col-md-1 col-xs-12">
        <button class="btn btn-success btn-xs btn-block" title="Export PDF" onclick="exportPDF();"><i
