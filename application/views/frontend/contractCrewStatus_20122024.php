                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr style="background-color:#067780;color:#FFF;height:30px;">
                                            ...
                                            <th style="vertical-align:middle;width:15%;text-align:center;">Full Name
                                            </th>
                                            <th style="vertical-align:middle;width:10%;text-align:center;">Nationality
                                            </th>
                                            <th style="vertical-align:middle;width:10%;text-align:center;">Birth</th>
                                            <th style="vertical-align:middle;width:10%;text-align:center;">Last Vessel
                                            </th>
                                            <th style="vertical-align:middle;width:10%;text-align:center;">Sign On</th>
                                            <th style="vertical-align:middle;width:10%;text-align:center;">Sign Off</th>
                                            <th style="vertical-align:middle;width:10%;text-align:center;">Est. Sign Off
                                            </th>
                                            <th style="vertical-align:middle;width:5%;text-align:center;">Action</th>
                                        </tr>
                                    </thead>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="evaluasiModalLabel">Pilih Departemen</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Tutup"></button>
                </div>
                <div class="modal-body text-center">
                    <button type="button" class="btn btn-primary m-2" onclick="generateLink('DECK')">DECK</button>
                    <button type="button" class="btn btn-secondary m-2" onclick="generateLink('ENGINE')">ENGINE</button>
                </div>
